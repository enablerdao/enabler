...
export const sRankServices: Service[] = [
  ...
  },
  {
    ...
    brandStory: 'StayFlowは「面倒」や「手間」を排除し、宿泊施設の運営管理を完全にシームレスにすること���、ホストが本来の価値である『ゲストへのおもてなし』に集中できる世界を目指しています。宿泊施設の業務を「流れるように」スムーズにすることから、『StayFlow』という名前が生まれました。宿泊業界をテクノロジーで変革し、誰もが気軽にホスティングを楽しめる社会を作ります。',
    features: [
      {
        title: '📅 予約一元管理',
