...
import { Target, Eye, Lightbulb, ArrowRight, Rocket, Globe, HeartHandshake, Sparkles, Zap, Compass } from 'lucide-react';
          ...
          <div className="container mx-auto px-6">
            <MotionBox>
              <div className="text-center mb-16">
                <div className="inline-flex items-center gap-2 bg-enabler-50 text-enabler-700 px-3 py-1 rounded-full text-sm font-medium mb-6">
                  <Compass size={14} />
                  <span>私たちの方向性</span>
                </div>
                ...
                <p className="text-gray-600 max-w-2xl mx-auto text-lg">
                  私たちが情熱を注ぐ進むべき道と、共に創り上げたい未来についてご紹介します。
                </p>
              </div>
            </MotionBox>
              ...
              <MotionBox delay={100}>
                <div className="bg-white rounded-xl shadow-subtle p-8 h-full relative overflow-hidden group">
                  ...
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <div className="text-enabler-600 text-sm font-semibold tracking-wider uppercase mb-1">
                        MISSION
                      </div>
                      <h2 className="text-2xl font-bold">ミッション</h2>
                    </div>
                  </div>
                  <div className="border-l-4 border-enabler-500 pl-6 py-5 mb-8 bg-enabler-50 rounded-r-lg relative">
                    <Sparkles className="absolute -left-2 -top-2 w-4 h-4 text-enabler-500" />
                ...
                <div className="relative z-10">
                  <div className="flex items-center mb-8">
                    <div className="bg-white p-3 rounded-full mr-4 shadow-sm">
                      <Zap size={24} className="text-enabler-600" />
                    </div>
                    <h2 className="text-2xl font-bold">私たちの行動指針</h2>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white rounded-lg p-6 shadow-subtle hover:shadow-md transition-shadow duration-300 border border-enabler-100 group relative overflow-hidden">
                      <div className="absolute -right-12 -bottom-12 w-24 h-24 bg-enabler-50 rounded-full opacity-0 group-hover:opacity-30 transition-all duration-700"></div>
            ...
            <MotionBox delay={400}>
              <div className="text-center bg-white rounded-xl p-8 shadow-subtle border border-gray-100 relative overflow-hidden group">
                <div className="absolute inset-0 bg-gradient-to-b from-enabler-50/0 to-enabler-50/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative z-10">
