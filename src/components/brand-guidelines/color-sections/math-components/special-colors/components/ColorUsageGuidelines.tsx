    ...
    >
      <div className="bg-blue-50 p-4 rounded-lg flex-1">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li><span className="font-medium">注意点</span>：創業年（2022年）の場合、基本カラーのみ存在し、特別カラーはありません</li>
          <li>ブランドの一貫性を保ちながら、毎年少しずつ進化するデザインを実現します</li>
        </ul>
      </div>
      
      <div className="bg-green-50 p-4 rounded-lg flex-1">
        <h5 className="font-medium mb-2">特別カラーの特徴（{currentYear}年現在）</h5>
        <ul className="list-disc pl-5 space-y-2">
          <li>フィボナッチ数列の年（1,2,3,5,8年目...）に節目として新しく設定</li>
          <li>創業年（2022年）には特別カラーはなく、2025年から始まります</li>
