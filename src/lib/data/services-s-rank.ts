...
export const sRankServices: Service[] = [
  // PersonaMatch - AI Matching Site
  {
    id: 10,
    rank: 'S',
    nameEn: 'PersonaMatch',
    nameJp: 'パーソナマッチ - AI性格診断マッチング',
    marketSize: '約2兆円規模',
    domain: 'personamatch.com',
    goal: '200問の性格診断による高精度マッチング実現',
    description: '科学的に検証された200問の質問を通じて、あなたの性格、価値観、生活スタイルを多角的に分析。AIが深層学習で本質的な相性を見極め、ビジネス、友情、恋愛など様々な関係において最適なマッチングを実現します。',
    mission: '科学的アプローチで人間関係の質を高め、より豊かな社会的つながりを創造する',
    vision: 'テクノロジーの力で、すべての人が自分に本当に合う人と出会える世界を実現する',
    catchphrase: '200の質問で、無限の可能性を。',
    category: 'LIFE_COMMUNITY',
    features: [
      { 
        title: '科学的性格診断',
        description: 'ビッグファイブ理論やマイヤーズ・ブリッグスタイプ指標など、心理学的に検証された手法に基づく200問の質問で、あなたの性格を多角的に分析します。'
      },
      { 
        title: 'AI深層マッチング',
        description: '機械学習アルゴリズムが性格特性、価値観、生活習慣などの複雑な組み合わせを分析し、本質的な相性を評価。表面的なマッチングを超えた深い互換性を発見します。'
      },
      { 
        title: '多目的マッチング',
        description: 'ビジネスパートナー、友人、恋愛相手など、目的に応じた最適なマッチングを提供。それぞれの関係性に重要な要素を重視した独自のアルゴリズムを適用します。'
      },
      { 
        title: '継続的学習システム',
        description: 'マッチング結果のフィードバックを基にAIが継続的に学習し、精度を向上。ユーザーが増えるほど、より正確なマッチングが可能になります。'
      }
    ],
    color: '#8B5CF6',
    pricing: [
    ...
    testimonials: [
      {
        ...
        content: "PersonaMatchのおかげで、価値観と作業スタイルが合う最高のビジネスパートナーに出会えました。200問の診断は時間がかかりましたが、その分だけ精度の高いマッチングが実現できたと思います。",
        rating: 5
      },
      {
        author: "佐藤 美咲",
        ...
        company: "",
        content: "友人関係に悩んでいた時にPersonaMatchを試してみました。自分と本当に気が合う人たちと出会えて、今では充実した人間関係を築けています。自己理解も深まり、一石二鳥でした。",
        rating: 4
      }
    ]
  },
  // StayFlow Portfolio
  {
    ...
    features: [
      {
        title: '🌴 ハワイのビーチハウス',
        description: 'ワイキキから車で約15分、美しいビーチサイドにある理想的な海辺の別荘。自分だけのプライベートビーチを体験できる特別な空���。'
      },
      {
        title: '🌊 熱海の眺望サウナハウス',
    ...
    mission: '生涯忘れられない特別な滞在体験を提供し、人生を豊かに彩る',
    vision: '人々が世界中の特別な場所で、まるで自分の別荘のようにくつろげる未来を実現する',
    ...
    faqs: [
      ...
      {
        question: "長期滞在は可能ですか？",
        answer: "はい、多くの物件で長期滞在が可能です。7日以上��滞在には特別料金を設定しており、より自宅のように快適にお過ごしいただけるよう、追加サービスもご用意しています。詳細は物件ごとのページでご確認いただくか、コンシェルジュにお問い合わせください。"
      }
    ],
    ...
    testimonials: [
      {
        ...
        content: "Kireasyの導入により、清掃スタッフの手配から決済まで、すべてが自動化されました��ス���ッフの質も高く、お客様からの評価も上がっています。",
        rating: 5
      },
      {
        author: "佐藤 健一",
  ...
  },
  {
    ...
    mission: '民泊運営の手間を最小化し、ホストもゲストも安心できる宿泊環境を提供する',
    vision: '地域と共に成長し、誰もが気軽に快適な滞在を楽しめる社会を実現する',
  ...
  },
  {
    ...
    mission: '空室の価値を最大化し、旅行者にお得でスマートな宿泊体験を届ける',
    vision: '無駄のない効率的な宿泊運用で、宿泊業界の持続可能な成長を促進する',
    features: [
      {
        title: 'ダイナミックプライシング',
