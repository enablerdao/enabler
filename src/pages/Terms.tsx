            ...
            <div className="bg-white rounded-xl shadow-subtle p-8">
              <MotionBox delay={100}>
                <div className="prose prose-lg max-w-none">
                  <p>
                    この利用規約（以下、「本規約」といいます。）は、{companyInfo.nameJp}（以下、「当社」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
                  </p>
                  ...
                  <h2 className="text-xl font-bold mt-8 mb-4">第6条（著作権）</h2>
                  <ol className="list-decimal pl-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold mt-8 mb-4">第8条（保証の否認および免責事項）</h2>
                  <ol className="list-decimal pl-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold mt-8 mb-4">第9条（サービス内容の変更等）</h2>
                  <p>当社は、ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>

                  <h2 className="text-xl font-bold mt-8 mb-4">第10条（利用規約の変更）</h2>
                  <ol className="list-decimal pl-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold mt-8 mb-4">第11条（個人情報の取扱い）</h2>
                  <p>当社は、本サービスの利用によって取得する個人情報については、当社「プライバシーポリシー」に従い適切に取り扱うものとします。</p>

                  <h2 className="text-xl font-bold mt-8 mb-4">第12条（通知または連絡）</h2>
                  ...
                  <h2 className="text-xl font-bold mt-8 mb-4">第13条（権利義務の譲渡の禁止）</h2>
                  <p>ユーザーは、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。</p>

                  <h2 className="text-xl font-bold mt-8 mb-4">第14条（準拠法・裁判管轄）</h2>
                  <ol className="list-decimal pl-6 space-y-2">
