  ...
  return (
    <div className="mb-6">
      ...
      <p className="text-base mb-4 leading-relaxed">
        2025年は特別なブルーカラーの年とし、2026年から始まるフィボナッチ数列の累積和（1周目、2周目、3周目…）の節目の年に特別なアクセントカラーを使用します。
      </p>
      
      <p className="text-base mb-4 leading-relaxed">
        2026年からは「黄金角（約137.5度）」を用いてアクセントカラーを決定します。これは自然界において最も美しい調和を生み出す角度であり、特別な節目を祝福する意味を込めています。
      </p>
    </div>
  );
};
